...
int main(int ac, char *av[], char *envp[]) {
  ...
  if (!method) {
    ...
    cout << "<h1>testCgi</h1>\r\n";
    cout << "<h2>Summary</h>\r\n";
    cout << "<p>This CGI script is designed to test the document response.<br>\
                The document content displays all environment variables,<br>\
                the body read in the case of POST, and the command line to check for meta variables,<br>\
                so that you can monitor how the CGI execution environment is set up.</p>\r\n";
